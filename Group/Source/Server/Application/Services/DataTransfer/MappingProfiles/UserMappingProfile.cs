...
namespace Server.Application.Services.DataTransfer.MappingProfiles
{
    public class UserMappingProfile: Profile
    {
        public UserMappingProfile()
        {
            ...
            CreateMap<UserData, User>().ForPath(dto => dto.ProfileInfo.DisplayName, src => src.MapFrom(src => src.DisplayName));
            CreateMap<UserData, User>().ForPath(dto => dto.ProfileInfo.EmailAddress, src => src.MapFrom(src => src.Email));
            ...
            CreateMap<UserData, User>().ForPath(dto => dto.ProfileInfo.PhoneNumber, src => src.MapFrom(src => src.PhoneNumber));
