...
namespace Server.Application.Services.DataTransfer.MappingProfiles
{
    public class ShipmentStateMappingProfile: Profile
    {
        public ShipmentStateMappingProfile()
        {
            ...
            CreateMap<ShipmentStateData, ShipmentState>().ForMember(dto => dto.CurrentState, src => src.MapFrom(src => src.CurrentState));
            CreateMap<ShipmentStateData, ShipmentState>().ForMember(dto => dto.FromDate, src => src.MapFrom(src => src.FromDate));
            CreateMap<ShipmentStateData, ShipmentState>().ForMember(dto => dto.ToDate, src => src.MapFrom(src => src.ToDate));
        }
    }
}
